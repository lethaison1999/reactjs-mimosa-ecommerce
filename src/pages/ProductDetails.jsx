...
const ProductDetails = () => {
  ...
  const { imgUrl, description, avgRating, price, reviews, shortDesc, productName, category } = product;
  ...
  const handleSubmit = (e) => {
    ...
    if (!msg || !enterName) {
      toast.error('Please enter name of message');
      return;
    }
                ...
                <div className="product__review mt-5">
                  <div className="review__wrapper">
                    ...
                    <div className="review__form">
                      ...
                      <form action="" refs="form" onSubmit={handleSubmit}>
